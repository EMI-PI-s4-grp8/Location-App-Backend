...
public Logement addLogements( Logement logement){
	return logementRepository.save(logement);
};


public Optional<Logement> findLogementById(Long id) {
...
public void deleteLogementById(Long id) {
